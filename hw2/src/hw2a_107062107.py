# -*- coding: utf-8 -*-
"""hw2a_107062107.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1GeRu5wultEShtV7mW7uDnfW_44fx0jHk
...
def convolution(input, weight, bitWidth):
  ...
  return output, partial, overflow, add, mul
...
def model(x, input_scale, conv1_weight, conv1_output_scale, conv2_weight, 
  ...
  # convolution & relu
  x, p, of1, a1, m1 = convolution(x, conv1_weight, bitWidth)

  # the below code is to print the number of additions and multiplication in each layer
  # TA can uncomment to see the print
  # it's same in the below 4 layers
  # print('layer 1 - the number of additions: ', a1)
  # print('layer 1 - the number of multiplication: ', m1)
  ...
  # --- layer 2 convoultion --- #
  # convolution & relu
  x, p, of2, a2, m2 = convolution(x, conv2_weight, bitWidth)
  # print('layer 2 - the number of additions: ', a2)
  # print('layer 2 - the number of multiplication: ', m2)
  partial = np.concatenate((partial, x.reshape(-1)))
  x[x < 0] = 0
  ...
  x, p, of3, a3, m3 = fc(x, fc1_weight, bitWidth)
  # print('layer 3 - the number of additions: ', a3)
  # print('layer 3 - the number of multiplication: ', m3)
  partial = np.concatenate((partial, x.reshape(-1)))
  x[x < 0] = 0
  ...
  # fully connected & relu
  x, p, of4, a4, m4 = fc(x, fc2_weight, bitWidth)
  # print('layer 4 - the number of additions: ', a4)
  # print('layer 4 - the number of multiplication: ', m4)
  partial = np.concatenate((partial, x.reshape(-1)))
  x[x < 0] = 0
  ...
  # fully connected
  x, p, of5, a5, m5 = fc_with_bias(x, fc3_weight, fc3_bias, bitWidth)
  # print('layer 5 - the number of additions: ', a5)
  # print('layer 5 - the number of multiplication: ', m5)
  ...
  # print whether the image is overflow or not
  # if TA wants to check the log
  # uncomment the below code
  '''
  overflow = of1 or of2 or of3 or of4 or of5
  if overflow:
    print('overflow: True')
  else:
...
"""### Test the accuracy & plot the distribution of partial sums"""

bit = 32
print("bit-width:", bit, " ->  accuracy : ", test(testloader, bit))

"""### Implementation for the images from testset & trainset
...
# 1300
i1, _ = testset[1300]
r1, _ = model(i1.numpy(), input_scale, conv1_weight, conv1_output_scale, conv2_weight, 
      conv2_output_scale, fc1_weight, fc1_output_scale, fc2_weight, fc2_output_scale, 
      fc3_weight, fc3_bias, fc3_output_scale, bitWidth-1)
print("testset 1300: ", r1)

# 3108
i2, _ = testset[3108]
r2, _ = model(i2.numpy(), input_scale, conv1_weight, conv1_output_scale, conv2_weight, 
      conv2_output_scale, fc1_weight, fc1_output_scale, fc2_weight, fc2_output_scale, 
      fc3_weight, fc3_bias, fc3_output_scale, bitWidth-1)
print("testset 3108: ", r2)

# 21280
i3, _ = trainset[21280]
r3, _ = model(i3.numpy(), input_scale, conv1_weight, conv1_output_scale, conv2_weight, 
      conv2_output_scale, fc1_weight, fc1_output_scale, fc2_weight, fc2_output_scale, 
      fc3_weight, fc3_bias, fc3_output_scale, bitWidth-1)
print("testset 21280: ", r3)

# 30702
i4, _ = trainset[30702]
r4, _ = model(i4.numpy(), input_scale, conv1_weight, conv1_output_scale, conv2_weight, 
      conv2_output_scale, fc1_weight, fc1_output_scale, fc2_weight, fc2_output_scale, 
      fc3_weight, fc3_bias, fc3_output_scale, bitWidth-1)
print("testset 30702: ", r4)
